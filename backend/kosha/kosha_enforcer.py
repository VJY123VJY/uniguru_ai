...
VALID_DOMAINS = {
    ...
    "chemistry", "biology", "agricultural", "general", "dharma_systems",
    "ecology", "governance", "puranas",
    # Legacy domains from existing Kosha entries
    "agriculture", "urban", "water / rivers", "infrastructure",
    "urban / society", "water management", "bhagavad gita", "sanskrit queries",
    "agriculture + ecology", "infrastructure + temples",
}

DOMAIN_ALIASES = {
    "urban / society": "urban",
    "water management": "water / rivers",
    "bhagavad gita": "gitas",
    "sanskrit queries": "general",
    "agriculture + ecology": "agriculture",
    "infrastructure + temples": "infrastructure",
    "dharma systems": "dharma_systems",
}
...
class KoshaEnforcer:
    ...
    def validate_existing_entries(cls, entries: List[KoshaEntry]) -> Dict[str, Any]:
        ...
        for entry in entries:
            issues = []
            normalized_domain = cls.normalize_domain(entry.domain or "")
